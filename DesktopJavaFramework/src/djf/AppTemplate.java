...
public abstract class AppTemplate extends Application {
	...
	try {
            ...
            alert.setHeaderText("Please choose a language that you prefer" + "\n" +
                    "请选择您喜欢的语言");
            alert.setContentText("Choose your option below :) " + "\n" +
                    "请选择下面的选项 : )");

            ButtonType buttonTypeOne = new ButtonType("English");
            ButtonType buttonTypeTwo = new ButtonType("简体中文");
