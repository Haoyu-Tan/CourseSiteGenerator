...
function initPage() {
	...
	var teamText =
		...
		+ "</tr>\n"
		+ "<tr>\n";
	teamText += addStudentToTeam(team.students[LEAD_ROLE], "purple");
	teamText += addStudentToTeam(team.students[PM_ROLE], "purple");
	teamText += addStudentToTeam(team.students[DESIGN_ROLE], "purple");
	teamText += addStudentToTeam(team.students[DATA_ROLE], "purple");
